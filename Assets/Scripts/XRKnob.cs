    ...
    public class XRKnob : XRBaseInteractable
    {
        ...
        struct TrackedRotation
        {
            ...
            public void SetTargetFromVector(Vector3 direction)
            {
                ...
                //{
                //    Debug.Log($"Rotating Clockwise: Offset = {m_CurrentOffset}");
                //}
                //else if (m_CurrentOffset < 0)
                //{
                //    Debug.Log($"Rotating Counterclockwise: Offset = {m_CurrentOffset}");
                //}
        ...
        void UpdateRotation(bool freshCheck = false)
        {
            ...
            var knobRotation = m_BaseKnobRotation - ((m_UpVectorAngles.totalOffset + m_ForwardVectorAngles.totalOffset) * m_TwistSensitivity) - m_PositionAngles.totalOffset;
            float rotationDelta = knobRotation - m_CumulativeRotation;
            ...
            //Debug.Log($"Rot Delta: {rotationDelta}");
            ...
            m_CumulativeRotation = knobRotation;
            // Clamp to range
            //if (m_ClampedMotion)
            ...
            //if (screw != null)
            //{
            //    float currentRot = screw.currentRotation;
            //    float totalRot = screw.totalRotation;

            //    if (currentRot >= totalRot && rotDir > 0)
            //    {
            //        knobRotation = Mathf.Clamp01(knobRotation);
            //    }
            //    else if (currentRot < 0.1 && rotDir < 0)
            //    {
            //        rotDir = 0;
            //    }
            //}
        ...
        float ValueToRotation()
        {
            ...
            return Mathf.LerpUnclamped(m_MinAngle, m_MaxAngle, m_Value);
        }
